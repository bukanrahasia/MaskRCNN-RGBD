...
class MaskRCNN():
    ...
    def build(self, mode, config):
        ...
        P5 = KL.Conv2D(config.TOP_DOWN_PYRAMID_SIZE, (1, 1), name='fpn_c5p5RGB')(C5)
        P4 = KL.Add(name="fpn_p4addRGB")([
            KL.UpSampling2D(size=(2, 2), name="fpn_p5upsampledRGB")(P5),
            KL.Conv2D(config.TOP_DOWN_PYRAMID_SIZE, (1, 1), name='fpn_c4p4RGB')(C4)])
        P3 = KL.Add(name="fpn_p3addRGB")([
            KL.UpSampling2D(size=(2, 2), name="fpn_p4upsampledRGB")(P4),
            KL.Conv2D(config.TOP_DOWN_PYRAMID_SIZE, (1, 1), name='fpn_c3p3RGB')(C3)])
        P2 = KL.Add(name="fpn_p2addRGB")([
            KL.UpSampling2D(size=(2, 2), name="fpn_p3upsampledRGB")(P3),
            KL.Conv2D(config.TOP_DOWN_PYRAMID_SIZE, (1, 1), name='fpn_c2p2RGB')(C2)])
        # Attach 3x3 conv to all P layers to get the final feature maps.
        P2 = KL.Conv2D(config.TOP_DOWN_PYRAMID_SIZE, (3, 3), padding="SAME", name="fpn_p2RGB")(P2)
        P3 = KL.Conv2D(config.TOP_DOWN_PYRAMID_SIZE, (3, 3), padding="SAME", name="fpn_p3RGB")(P3)
        P4 = KL.Conv2D(config.TOP_DOWN_PYRAMID_SIZE, (3, 3), padding="SAME", name="fpn_p4RGB")(P4)
        P5 = KL.Conv2D(config.TOP_DOWN_PYRAMID_SIZE, (3, 3), padding="SAME", name="fpn_p5RGB")(P5)
        # P6 is used for the 5th anchor scale in RPN. Generated by
        # subsampling from P5 with stride of 2.
        P6 = KL.MaxPooling2D(pool_size=(1, 1), strides=2, name="fpn_p6RGB")(P5)

        # Top-down Layers
        # TODO: add assert to varify feature map sizes match what's in config
        P5D = KL.Conv2D(config.TOP_DOWN_PYRAMID_SIZE, (1, 1), name='fpn_c5p5DEPTH')(C5D)
        P4D = KL.Add(name="fpn_p4addDEPTH")([
            KL.UpSampling2D(size=(2, 2), name="fpn_p5upsampledDEPTH")(P5D),
            KL.Conv2D(config.TOP_DOWN_PYRAMID_SIZE, (1, 1), name='fpn_c4p4DEPTH')(C4D)])
        P3D = KL.Add(name="fpn_p3addDEPTH")([
            KL.UpSampling2D(size=(2, 2), name="fpn_p4upsampledDEPTH")(P4D),
            KL.Conv2D(config.TOP_DOWN_PYRAMID_SIZE, (1, 1), name='fpn_c3p3DEPTH')(C3D)])
        P2D = KL.Add(name="fpn_p2addDEPTH")([
            KL.UpSampling2D(size=(2, 2), name="fpn_p3upsampledDEPTH")(P3D),
            KL.Conv2D(config.TOP_DOWN_PYRAMID_SIZE, (1, 1), name='fpn_c2p2DEPTH')(C2D)])
        # Attach 3x3 conv to all P layers to get the final feature maps.
        P2D = KL.Conv2D(config.TOP_DOWN_PYRAMID_SIZE, (3, 3), padding="SAME", name="fpn_p2DEPTH")(P2D)
        P3D = KL.Conv2D(config.TOP_DOWN_PYRAMID_SIZE, (3, 3), padding="SAME", name="fpn_p3DEPTH")(P3D)
        P4D = KL.Conv2D(config.TOP_DOWN_PYRAMID_SIZE, (3, 3), padding="SAME", name="fpn_p4DEPTH")(P4D)
        P5D = KL.Conv2D(config.TOP_DOWN_PYRAMID_SIZE, (3, 3), padding="SAME", name="fpn_p5DEPTH")(P5D)
        # P6 is used for the 5th anchor scale in RPN. Generated by
        # subsampling from P5 with stride of 2.
